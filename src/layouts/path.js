...
const LayoutPath =()=>
{
    return(
            <div id="layoutPath">
                ...
                <div id="titlePaths">
                    <p className="font-primary fc-secondary">Nuestros <span className="fc-terciary">Paths</span></p>
                </div>
                <div>            
                    <div className="containerPaths" >
                        <div className="mb-1 perfectCentered fdc">
                                ...
                                <div>
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" className="svgPaths" viewBox="0 0 24 24"><circle cx="17" cy="4" r="2"/>
                                ...
                                <div>
                                    ...
                                    <p  className="font-secondary pbothLR tx-c fs-1-3">Serás un jr Frontend Developer. Podrás crear interfaces de usuario interactivas e integrarlas con servicios propios o de terceros.</p>
                    ...
                    <div className="pbothLR" >
                        ...
                        <div>
                            <p  className="font-secondary mb-1 fs-2"><span className="font-secondaryTitle">Warrior:</span> proximamente</p>
                            <p  className="font-secondary mb-1 fs-2"><span className="font-secondaryTitle">Master:</span> proximamente</p>
                        </div>
                        <p  className="font-secondary mb-1 fs-2 tx-c"><span className="font-secondaryTitle">Ancient:</span> proximamente</p>
